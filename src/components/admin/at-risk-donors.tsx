...
Masjid Ar-Raudhah`
  ...
  async function handleSendReminder(donorId: number) {
    await fetch('/api/cron/send-reminders', {
      method: 'POST',
          ...
          {pledges.map((p) => (
            ...
            >
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                <button
                  onClick={() => handleSendReminder(p.donorId)}
                  className="flex items-center gap-1.5 rounded-lg bg-primary-50 dark:bg-primary-900/20 px-3 py-1.5 text-xs font-medium text-primary-700 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-900/40 transition-colors"
                >
                  Send Reminder
                </button>
                <a
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg bg-gray-50 dark:bg-gray-700/50 px-3 py-1.5 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg bg-amber-50 dark:bg-amber-900/20 px-3 py-1.5 text-xs font-medium text-amber-700 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 transition-colors"
                >
