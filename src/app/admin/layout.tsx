...
function AdminLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  // If not authenticated, render children (which will handle redirect)
  if (!session) {
    return <>{children}</>
  }
  ...
  return (
    <div className="min-h-screen flex bg-warmWhite dark:bg-gray-900">
      {/* Mobile overlay */}
      {sidebarOpen && (
        <div
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="sticky top-0 z-30 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 px-4 sm:px-6 h-16 flex items-center justify-between">
